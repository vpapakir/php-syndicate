...
var href;if(href=element.href){if(href.indexOf('#')==-1){element.onclick=function(){return false;};}else{element.href='javascript:void(0)';}}else{element.style.cursor='pointer';if(element.type&&(element.type=='checkbox'||element.type=='radio')){element.onclick=function(){return true;};}else{if(element.tagName=='LI'){element.onclick=function(){return false;};}else{element.onclick=function(){return false;};}}}
