function Installer()  {
	...
	this.checklistErrorMessages = Array(
			'phpSyndicate needs at least PHP version 5.0 or later, please upgrade your PHP binaries.<br/><br/>',
			...
			'The php.ini setting "allow_url_fopen" must be set to 1, without allow_url_fopen enabled phpSyndicate cannot fetch data from remote sites!<br/><br/>',
			...
			'Correct folder permissions are crucial for phpSyndicate to work with fetched content, caching and other things, please chmod your folders correctly.<br/><br/>',
			'You need to manually create the file "config.php" in your phpSyndicate root directory.  The file needs to be writeable for the installer.  Please chmod the file correctly (If you are on Unix based system, you can run <i>"chmod 666 config.php"</i> to make it writeable).<br/><br/>',
			'Without any database module loaded on the web-server phpSyndicate cannot function.  Please enable some of the optional database modules so you can run phpSyndicate.<br/><br/>'
	...
	this.handleStep = function(iStep) {
		...
		switch(iStep) {
			...
			case 5:
				...
				selectFields = Array('s_register', /*'s_covers', 's_category',*/ 's_session');
			...
			case 8:
				...
				alert('Congratulations on successful install.\nNow taking you to your phpSyndicate website.');
